import { CheckCircle2, GraduationCap, Home, PartyPopper, PiggyBank, ShieldCheck, Sunrise, type LucideIcon } from "lucide-react";
    ...
    <article className={`surface-tile p-4 ${done ? "celebrate-glow" : ""}`}>
      ...
      <button
        ...
        onClick={() =>
            ...
            : toast.success(`Contribution to ${goal.name} — coming with the goal editor`)
        }
