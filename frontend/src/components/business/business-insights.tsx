...
import { businessInsights, type BusinessInsight } from "@/lib/business-data";
import { cn } from "@/lib/utils";

const toneStyle: Record<BusinessInsight["tone"], string> = {
  positive: "bg-success/12 text-success",
  caution: "bg-amber-500/12 text-amber-500",
  neutral: "bg-primary/12 text-primary",
};

/** AI business insights rail with mock quick actions. */
