...
import { loanInsights, type LoanInsight } from "@/lib/loans-data";
import { cn } from "@/lib/utils";

const toneStyle: Record<LoanInsight["tone"], string> = {
  positive: "bg-success/12 text-success",
  caution: "bg-amber-500/12 text-amber-500",
  neutral: "bg-primary/12 text-primary",
};

/** AI loan recommendations rail. */
